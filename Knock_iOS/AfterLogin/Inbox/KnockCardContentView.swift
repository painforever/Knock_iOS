    ...
    var body: some View {
        VStack(alignment: .leading) {
            HStack {
                ...
                Text(knockResponse.username).fontWeight(.bold)
            }
